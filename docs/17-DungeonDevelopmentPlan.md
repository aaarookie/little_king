...
版本 1.8 · 2026-09-09 · UE 5.8。状态：**D0～D5 全部完成，阶段 2 地牢收口；下一阶段家园规划见 [26](26-HomeDevelopmentPlan.md)**。D5 当批自动化为 32/32；之后 BUG-018 为 37/37，详见 README 的最新验证入口。本文各 D 批次保留当时范围与验收历史。
...
下一批按用户要求进入 **阶段 3 家园局外循环**，详细规划见 [26](26-HomeDevelopmentPlan.md)，协作记录见 [27](27-HomeChangeLog.md)。七座建筑包含神像/金库升级、三个只读收藏入口、大门区域地图及战备处；英雄培养和法术研究暂不开放。当前仅完成家园规划，H0～H5 尚未开发。

D0～D5 的 RunSubsystem、遭遇快照、节点选择、奖励原子入口、原生结算/恢复 UI 与安全点存档继续作为回归基线。家园新增永久档及出征加成快照，必须迁移旧 Run Schema，不能用当前家园等级重算已在进行的远征。音效与表现素材仍后置，打包与硬件测试在准备发布时安排；不重新建立 Sprint 6 验收关卡。
