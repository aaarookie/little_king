...
2026-09-23 显示修复：24 个双足单位的四帧 Move 使用新图替换，旧 D 图集保留归档，双头龙/建筑原动作保留。新增 24 PNG、96 Sprite、24 Flipbook，共 144 引擎资产（累计 919）；源码与素材已接入，无须手动下载。见 [45 修复与验收](45-BattlePresentationFixes.md)、[46 提示词](46-MovementFixPrompts.md)。
